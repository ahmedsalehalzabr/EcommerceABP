...
public class EcommerceAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EcommerceAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
